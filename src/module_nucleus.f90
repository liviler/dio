...
!==============================================================================!
MODULE Nucleus
use Constants, only: r64, u_config
...
!-------------------------------------------------------------------------------------!
    ...
    subroutine printNucleusAttribute
        ...
        write(u_config,*)'*************************BEGIN set_nucleus********************'
        write(u_config,format1) 'Name:', nucleus_attributes%name
        write(u_config,format2) 'A(mass number):', nucleus_attributes%mass_number
        write(u_config,format2) 'Z(proton number):', nucleus_attributes%proton_number
        write(u_config,format2) 'N(neutron number):', nucleus_attributes%neutron_number
        write(u_config,"(a,/)")'*************************END set_nucleus*********************'
        close(u_config)
